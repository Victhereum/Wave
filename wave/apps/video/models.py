...
class Video(UIDTimeBasedModel):
    media = models.FileField(upload_to=MediaHelper.get_video_upload_path,
                             validators=[FileValidatorHelper.validate_video_extension,
                                         FileValidatorHelper.validate_video_size])
